...
task_routes = {
    'app.tasks.scraper.run_async_scraper': {'queue': 'scrape'},
    'app.tasks.scraper.run_continuous_scraper': {'queue': 'scrape'},
    'app.tasks.preprocess.preprocess_and_enqueue': {'queue': 'preprocess'},
    'app.tasks.pipeline_tasks.preprocess_article': {'queue': 'preprocess'},
    'app.tasks.pipeline_tasks.tag_article_ner': {'queue': 'preprocess'},
...
beat_schedule = {
    'run-continuous-scraper': {
        'task': 'app.tasks.scraper.run_continuous_scraper',
