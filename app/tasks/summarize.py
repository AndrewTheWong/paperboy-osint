...
def summarize_cluster(self, cluster_id: str, article_ids: List[str]):
    ...
    try:
        ...
        # Import services
        from app.services.supabase import get_articles_texts, update_cluster_summary
...
def summarize_all_pending_clusters(self):
    ...
    try:
        ...
        # Import services
        from app.services.supabase import get_pending_clusters
        ...
        for cluster in pending_clusters:
            try:
                ...
                if len(article_ids) >= 3:
                    ...
                    from app.services.supabase import update_cluster_summary
                    update_cluster_summary(
                        cluster_id=cluster_id,
